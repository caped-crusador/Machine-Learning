...
#     num_epochs=None,
#     shuffle=True)
# train_results = mnist_classifier.evaluate(
#     input_fn=train_input_fn_eval)
...
text_file = open("results_conv2_80%error.txt", "w")
text_file.write(str(eval_results))
text_file.close()

conv2_100 = eval(open("results_conv2_100%error.txt", "r").read())
